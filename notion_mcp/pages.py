...
class PageManager:
    ...
    def _build_page_properties(
        ...
        for key, value in properties.items():
            ...
            if isinstance(value, str):
                ...
                # Date property
                notion_properties[key] = {"date": {"start": value.isoformat()}}
            ...
            if parent_id:
                try:
                    ...
                    try:
                        ...
                        # Use new data_source_id type for 2025-09-03 compliance
                        page_data["parent"] = {
                            "type": "data_source_id",
    ...
    async def get_page_content(
        ...
        try:
            ...
            result = {"page": page, "blocks": [], "children_count": 0}
    ...
    async def get_page_tree(self, page_id: str, max_depth: int = 3) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {"page": page, "children": [], "depth": 0}
