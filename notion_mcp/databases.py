"""
NotionMCP - Data Source Management Operations
...
class DatabaseManager:
    ...
    def _build_database_sorts(
        ...
        for sort_item in sorts_config:
            if isinstance(sort_item, str):
                ...
                notion_sorts.append({"property": sort_item, "direction": "ascending"})
    ...
    async def create_database_entry(
        ...
        try:
            ...
            # Create the page as a data source entry (2025-09-03 compliance)
            page_data = {
        ...
        for prop_name, value in properties.items():
            ...
            if prop_type == "title":
                ...
                if isinstance(value, (datetime, date)):
                    ...
                    entry_properties[prop_name] = {"date": {"start": value}}
            elif prop_type == "checkbox":
    ...
    async def update_database(
        ...
        if properties:
            data["properties"] = self._build_property_schema(properties)

        return await self.client.update_database(database_id, **data)
